...
\input{sections/geometry_primitives}
\input{sections/orientation}
\input{sections/segment_intersection}
\input{sections/point_in_polygon}
\input{sections/collision_checking}
\input{sections/visibility_graphs}
